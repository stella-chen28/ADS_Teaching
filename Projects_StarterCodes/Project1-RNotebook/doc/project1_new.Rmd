...
Ps: the ratios here are refered to the number of collected samples, but not the panel. That is, if one person provides with 6 happy moments, it will be counted as 6 instead of 1.
...
```{r,warning=FALSE,message=FALSE}
wordcloud2(word_count_married[1:100,],size=0.5,shape="circle",color="random-dark")
```
